...
```{r DiagrammR, echo=FALSE, warnings=FALSE, fig.align='center'}
library("DiagrammeR")
DiagrammeR::grViz("digraph {
  
graph[rankdir = LR, bgcolor = transparent, size = '8,5']
...
1 [label = 'Data Acquisition']
2 [label = 'Data Cleaning']
3 [label = 'Transform']
4 [label = 'Visualize']
5 [label = 'Model']
6 [label = 'Analysis Results']
