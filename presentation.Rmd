...
<aside class="notes">
Good morning everyone, thank you all for comming. I am here today to talk to you about workflow in which you can easily share your analysis make it reproducible at . In the following slides I will be focusing of my talk will be focusing on shareability and reproducibility 
</aside>

##{data-background="#f7f2d3"}
...
However, I manged to keep doing that almost a year and half until this happen
...
DiagrammeR::grViz("digraph neato {
  graph [rankdir=LR,bgcolor=transparent,size='13,5', fontsize = 32, fontname = Helvetica, overlap = false];
  node [shape=circle, fontsize = 32, fontname = Helvetica ];
  ...
  edge [arrowsize=7 , arrowhead=vee]
  a [ label = 'Data\nAcquisition'  ]
  b [ label = 'Data\nCleaning' ]
  c [ label = 'Transform' ]
  d [ label = 'Visualize' ]
